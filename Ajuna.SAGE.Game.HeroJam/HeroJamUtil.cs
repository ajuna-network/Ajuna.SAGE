...
namespace Ajuna.SAGE.Game.HeroJam
{
    public class HeroJamUtil
    {
        ...
        {
            var baseItem = new BaseAssetBuilder(null, 0, COLLECTION_ID, AssetType.Item, (AssetSubType)ItemSubType.Meat)
                .Build();
        ...
        {
            var baseItem = new BaseAssetBuilder(null, 0, COLLECTION_ID, AssetType.Animal, assetSubType)
                .Build();
