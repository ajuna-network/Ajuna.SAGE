...
namespace Substrate.AjunaSolo.NET.RestService.Generated.Controller
{
    ...
    public sealed class VestingController : ControllerBase
    {
        ...
        [ProducesResponseType(typeof(Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT9), 200)]
        [StorageKeyBuilder(typeof(Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.VestingStorage), "VestingSchedulesParams", typeof(Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32))]
