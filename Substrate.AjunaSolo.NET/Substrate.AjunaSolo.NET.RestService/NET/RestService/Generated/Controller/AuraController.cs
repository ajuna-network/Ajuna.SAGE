...
namespace Substrate.AjunaSolo.NET.RestService.Generated.Controller
{
    ...
    public sealed class AuraController : ControllerBase
    {
        ...
        /// </summary>
        [HttpGet("Authorities")]
        [ProducesResponseType(typeof(Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT4), 200)]
        [StorageKeyBuilder(typeof(Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.AuraStorage), "AuthoritiesParams")]
        ...
        /// </summary>
        [HttpGet("CurrentSlot")]
        [ProducesResponseType(typeof(Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_consensus_slots.Slot), 200)]
        [StorageKeyBuilder(typeof(Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.AuraStorage), "CurrentSlotParams")]
