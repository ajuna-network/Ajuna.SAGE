...
namespace Substrate.AjunaSolo.NET.RestService.Generated.Controller
{
    ...
    public sealed class MultisigController : ControllerBase
    {
        ...
        /// </summary>
        [HttpGet("Multisigs")]
        [ProducesResponseType(typeof(Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_multisig.Multisig), 200)]
        [StorageKeyBuilder(typeof(Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.MultisigStorage), "MultisigsParams", typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.AjunaSolo.NET.NetApiExt.Generated.Types.Base.Arr32U8>))]
