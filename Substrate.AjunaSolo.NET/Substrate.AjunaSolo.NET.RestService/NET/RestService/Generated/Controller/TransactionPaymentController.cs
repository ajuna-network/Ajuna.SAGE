...
namespace Substrate.AjunaSolo.NET.RestService.Generated.Controller
{
    ...
    public sealed class TransactionPaymentController : ControllerBase
    {
        ...
        [ProducesResponseType(typeof(Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128), 200)]
        [StorageKeyBuilder(typeof(Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.TransactionPaymentStorage), "NextFeeMultiplierParams")]
        ...
        [ProducesResponseType(typeof(Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_transaction_payment.EnumReleases), 200)]
        [StorageKeyBuilder(typeof(Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.TransactionPaymentStorage), "StorageVersionParams")]
