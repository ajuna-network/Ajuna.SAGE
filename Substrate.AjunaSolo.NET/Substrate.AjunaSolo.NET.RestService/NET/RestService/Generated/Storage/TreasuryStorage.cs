...
namespace Substrate.AjunaSolo.NET.RestService.Generated.Storage
{
    ...
    public interface ITreasuryStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal GetProposals(string key);
        ...
        /// </summary>
        Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT17 GetApprovals();
        ...
        /// </summary>
        Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_treasury.SpendStatus GetSpends(string key);
    }
    ...
    public sealed class TreasuryStorage : ITreasuryStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal> _proposalsTypedStorage;
        ...
        /// </summary>
        private TypedStorage<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT17> _approvalsTypedStorage;
        ...
        /// </summary>
        private TypedMapStorage<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_treasury.SpendStatus> _spendsTypedStorage;
        ...
        public TreasuryStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.ProposalsTypedStorage = new TypedMapStorage<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal>("Treasury.Proposals", storageDataProvider, storageChangeDelegates);
            ...
            this.ApprovalsTypedStorage = new TypedStorage<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT17>("Treasury.Approvals", storageDataProvider, storageChangeDelegates);
            ...
            this.SpendsTypedStorage = new TypedMapStorage<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_treasury.SpendStatus>("Treasury.Spends", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedMapStorage<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal> ProposalsTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT17> ApprovalsTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_treasury.SpendStatus> SpendsTypedStorage
        {
            get
            {
        ...
        ///  Proposals that have been made.
        /// </summary>
        public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal GetProposals(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ProposalsTypedStorage.Dictionary.TryGetValue(key, out Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal result))
            {
                return result;
            }
            else
        ...
        ///  Proposal indices that have been approved but not yet awarded.
        /// </summary>
        public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT17 GetApprovals()
        {
        ...
        ///  Spends that have been approved and being processed.
        /// </summary>
        public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_treasury.SpendStatus GetSpends(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (SpendsTypedStorage.Dictionary.TryGetValue(key, out Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_treasury.SpendStatus result))
            {
                return result;
            }
            else
