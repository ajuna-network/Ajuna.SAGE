...
namespace Substrate.AjunaSolo.NET.RestService.Generated.Storage
{
    ...
    public interface IGrandpaStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_grandpa.EnumStoredState GetState();
        
        /// <summary>
        /// >> PendingChange
        ///  Pending change: (signaled at, scheduled change).
        /// </summary>
        Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_grandpa.StoredPendingChange GetPendingChange();
        ...
        /// </summary>
        Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT1 GetAuthorities();
    }
    ...
    public sealed class GrandpaStorage : IGrandpaStorage
    {
        ...
        /// </summary>
        private TypedStorage<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_grandpa.EnumStoredState> _stateTypedStorage;
        
        /// <summary>
        /// _pendingChangeTypedStorage typed storage field
        /// </summary>
        private TypedStorage<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_grandpa.StoredPendingChange> _pendingChangeTypedStorage;
        ...
        /// </summary>
        private TypedStorage<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT1> _authoritiesTypedStorage;
        ...
        {
            this.StateTypedStorage = new TypedStorage<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_grandpa.EnumStoredState>("Grandpa.State", storageDataProvider, storageChangeDelegates);
            this.PendingChangeTypedStorage = new TypedStorage<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_grandpa.StoredPendingChange>("Grandpa.PendingChange", storageDataProvider, storageChangeDelegates);
            ...
            this.AuthoritiesTypedStorage = new TypedStorage<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT1>("Grandpa.Authorities", storageDataProvider, storageChangeDelegates);
        }
        
        /// <summary>
        /// _stateTypedStorage property
        /// </summary>
        public TypedStorage<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_grandpa.EnumStoredState> StateTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_grandpa.StoredPendingChange> PendingChangeTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT1> AuthoritiesTypedStorage
        {
            get
            {
        ...
        ///  State of the current authority set.
        /// </summary>
        public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_grandpa.EnumStoredState GetState()
        {
        ...
        ///  Pending change: (signaled at, scheduled change).
        /// </summary>
        public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_grandpa.StoredPendingChange GetPendingChange()
        {
        ...
        ///  The current list of authorities.
        /// </summary>
        public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT1 GetAuthorities()
        {
