...
namespace Substrate.AjunaSolo.NET.RestService.Generated.Storage
{
    ...
    public interface ISchedulerStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT21 GetAgenda(string key);
        
        /// <summary>
        /// >> Retries
        ///  Retry configurations for items to be executed, indexed by task address.
        /// </summary>
        Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_scheduler.RetryConfig GetRetries(string key);
    ...
    public sealed class SchedulerStorage : ISchedulerStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT21> _agendaTypedStorage;
        
        /// <summary>
        /// _retriesTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_scheduler.RetryConfig> _retriesTypedStorage;
        ...
        public SchedulerStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.AgendaTypedStorage = new TypedMapStorage<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT21>("Scheduler.Agenda", storageDataProvider, storageChangeDelegates);
            this.RetriesTypedStorage = new TypedMapStorage<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_scheduler.RetryConfig>("Scheduler.Retries", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedMapStorage<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT21> AgendaTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_scheduler.RetryConfig> RetriesTypedStorage
        {
            get
            {
        ...
        ///  Items to be executed, indexed by the block number that they should be executed on.
        /// </summary>
        public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT21 GetAgenda(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (AgendaTypedStorage.Dictionary.TryGetValue(key, out Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT21 result))
            {
                return result;
            }
            else
        ...
        ///  Retry configurations for items to be executed, indexed by task address.
        /// </summary>
        public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_scheduler.RetryConfig GetRetries(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (RetriesTypedStorage.Dictionary.TryGetValue(key, out Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_scheduler.RetryConfig result))
            {
                return result;
            }
            else
