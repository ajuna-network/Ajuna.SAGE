...
using Substrate.AjunaSolo.NET.RestService.Formatters;
...
namespace Substrate.AjunaSolo.NET.RestService
{
   ...
   public class Startup
   {
      ...
      public void ConfigureServices(IServiceCollection services)
      {
         ...
         services.AddSwaggerGen(c =>
         {
            ...
            c.SwaggerDoc("v1", new OpenApiInfo { Title = "Substrate.AjunaSolo.NET.RestService", Version = "v1" });
         });
      }
      ...
      public void Configure(IApplicationBuilder app, IWebHostEnvironment env, StorageSubscriptionHandler handler)
      {
         ...
         app.UseSwaggerUI(
             c =>
             {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Substrate.AjunaSolo.NET.RestService v1");
             }
         );
