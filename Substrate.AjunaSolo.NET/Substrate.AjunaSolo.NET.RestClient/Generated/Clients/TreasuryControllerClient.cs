...
namespace Substrate.AjunaSolo.NET.RestClient.Generated.Clients
{
   ...
   public sealed class TreasuryControllerClient : BaseClient, ITreasuryControllerClient
   {
      ...
      {
         return await SendRequestAsync<Proposal>(_httpClient, "treasury/proposals", Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.TreasuryStorage.ProposalsParams(key));
      }
      public async Task<bool> SubscribeProposals(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Treasury.Proposals", Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.TreasuryStorage.ProposalsParams(key));
      }
      ...
      {
         return await SendRequestAsync<SpendStatus>(_httpClient, "treasury/spends", Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.TreasuryStorage.SpendsParams(key));
      }
      public async Task<bool> SubscribeSpends(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Treasury.Spends", Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.TreasuryStorage.SpendsParams(key));
      }
   }
}
