...
namespace Substrate.AjunaSolo.NET.RestClient.Generated.Clients
{
   ...
   public sealed class SystemControllerClient : BaseClient, ISystemControllerClient
   {
      ...
      public async Task<AccountInfo> GetAccount(Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await SendRequestAsync<AccountInfo>(_httpClient, "system/account", Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.SystemStorage.AccountParams(key));
      }
      public async Task<bool> SubscribeAccount(Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("System.Account", Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.SystemStorage.AccountParams(key));
      }
      ...
      {
         return await SendRequestAsync<H256>(_httpClient, "system/blockhash", Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.SystemStorage.BlockHashParams(key));
      }
      public async Task<bool> SubscribeBlockHash(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("System.BlockHash", Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.SystemStorage.BlockHashParams(key));
      }
      public async Task<BaseVec<U8>> GetExtrinsicData(U32 key)
      {
         return await SendRequestAsync<BaseVec<U8>>(_httpClient, "system/extrinsicdata", Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.SystemStorage.ExtrinsicDataParams(key));
      }
      public async Task<bool> SubscribeExtrinsicData(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("System.ExtrinsicData", Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.SystemStorage.ExtrinsicDataParams(key));
      }
      ...
      {
         return await SendRequestAsync<BaseVec<BaseTuple<U32, U32>>>(_httpClient, "system/eventtopics", Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.SystemStorage.EventTopicsParams(key));
      }
      public async Task<bool> SubscribeEventTopics(H256 key)
      {
         return await _subscriptionClient.SubscribeAsync("System.EventTopics", Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.SystemStorage.EventTopicsParams(key));
      }
