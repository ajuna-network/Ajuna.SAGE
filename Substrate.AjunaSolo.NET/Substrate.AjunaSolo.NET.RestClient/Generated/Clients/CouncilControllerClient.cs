...
namespace Substrate.AjunaSolo.NET.RestClient.Generated.Clients
{
   ...
   public sealed class CouncilControllerClient : BaseClient, ICouncilControllerClient
   {
      ...
      {
         return await SendRequestAsync<BoundedVecT10>(_httpClient, "council/proposals");
      }
      ...
      {
         return await SendRequestAsync<EnumRuntimeCall>(_httpClient, "council/proposalof", Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.CouncilStorage.ProposalOfParams(key));
      }
      public async Task<bool> SubscribeProposalOf(Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.primitive_types.H256 key)
      {
         return await _subscriptionClient.SubscribeAsync("Council.ProposalOf", Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.CouncilStorage.ProposalOfParams(key));
      }
      public async Task<Votes> GetVoting(Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.primitive_types.H256 key)
      {
         return await SendRequestAsync<Votes>(_httpClient, "council/voting", Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.CouncilStorage.VotingParams(key));
      }
      public async Task<bool> SubscribeVoting(Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.primitive_types.H256 key)
      {
         return await _subscriptionClient.SubscribeAsync("Council.Voting", Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.CouncilStorage.VotingParams(key));
      }
