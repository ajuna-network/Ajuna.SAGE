...
namespace Substrate.AjunaSolo.NET.RestClient.Generated.Clients
{
   ...
   public sealed class TechnicalCommitteeControllerClient : BaseClient, ITechnicalCommitteeControllerClient
   {
      ...
      public async Task<EnumRuntimeCall> GetProposalOf(Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.primitive_types.H256 key)
      {
         return await SendRequestAsync<EnumRuntimeCall>(_httpClient, "technicalcommittee/proposalof", Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.TechnicalCommitteeStorage.ProposalOfParams(key));
      }
      public async Task<bool> SubscribeProposalOf(Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.primitive_types.H256 key)
      {
         return await _subscriptionClient.SubscribeAsync("TechnicalCommittee.ProposalOf", Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.TechnicalCommitteeStorage.ProposalOfParams(key));
      }
      public async Task<Votes> GetVoting(Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.primitive_types.H256 key)
      {
         return await SendRequestAsync<Votes>(_httpClient, "technicalcommittee/voting", Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.TechnicalCommitteeStorage.VotingParams(key));
      }
      public async Task<bool> SubscribeVoting(Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.primitive_types.H256 key)
      {
         return await _subscriptionClient.SubscribeAsync("TechnicalCommittee.Voting", Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.TechnicalCommitteeStorage.VotingParams(key));
      }
