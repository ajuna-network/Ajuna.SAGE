...
namespace Substrate.AjunaSolo.NET.RestClient.Generated.Clients
{
   ...
   public sealed class DemocracyControllerClient : BaseClient, IDemocracyControllerClient
   {
      ...
      public async Task<BoundedVecT18> GetPublicProps()
      {
         return await SendRequestAsync<BoundedVecT18>(_httpClient, "democracy/publicprops");
      }
      public async Task<bool> SubscribePublicProps()
      {
         return await _subscriptionClient.SubscribeAsync("Democracy.PublicProps");
      }
      public async Task<BaseTuple<BoundedVecT19, U128>> GetDepositOf(U32 key)
      {
         return await SendRequestAsync<BaseTuple<BoundedVecT19, U128>>(_httpClient, "democracy/depositof", Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.DemocracyStorage.DepositOfParams(key));
      }
      public async Task<bool> SubscribeDepositOf(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Democracy.DepositOf", Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.DemocracyStorage.DepositOfParams(key));
      }
      ...
      {
         return await SendRequestAsync<EnumReferendumInfo>(_httpClient, "democracy/referenduminfoof", Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.DemocracyStorage.ReferendumInfoOfParams(key));
      }
      public async Task<bool> SubscribeReferendumInfoOf(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Democracy.ReferendumInfoOf", Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.DemocracyStorage.ReferendumInfoOfParams(key));
      }
      public async Task<EnumVoting> GetVotingOf(Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await SendRequestAsync<EnumVoting>(_httpClient, "democracy/votingof", Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.DemocracyStorage.VotingOfParams(key));
      }
      public async Task<bool> SubscribeVotingOf(Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Democracy.VotingOf", Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.DemocracyStorage.VotingOfParams(key));
      }
      ...
      public async Task<BaseTuple<U32, BoundedVecT19>> GetBlacklist(H256 key)
      {
         return await SendRequestAsync<BaseTuple<U32, BoundedVecT19>>(_httpClient, "democracy/blacklist", Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.DemocracyStorage.BlacklistParams(key));
      }
      public async Task<bool> SubscribeBlacklist(H256 key)
      {
         return await _subscriptionClient.SubscribeAsync("Democracy.Blacklist", Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.DemocracyStorage.BlacklistParams(key));
      }
      public async Task<Bool> GetCancellations(H256 key)
      {
         return await SendRequestAsync<Bool>(_httpClient, "democracy/cancellations", Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.DemocracyStorage.CancellationsParams(key));
      }
      public async Task<bool> SubscribeCancellations(H256 key)
      {
         return await _subscriptionClient.SubscribeAsync("Democracy.Cancellations", Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.DemocracyStorage.CancellationsParams(key));
      }
      public async Task<H256> GetMetadataOf(EnumMetadataOwner key)
      {
         return await SendRequestAsync<H256>(_httpClient, "democracy/metadataof", Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.DemocracyStorage.MetadataOfParams(key));
      }
      public async Task<bool> SubscribeMetadataOf(EnumMetadataOwner key)
      {
         return await _subscriptionClient.SubscribeAsync("Democracy.MetadataOf", Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.DemocracyStorage.MetadataOfParams(key));
      }
   }
}
