...
namespace Substrate.AjunaSolo.NET.RestClient.Generated.Clients
{
   ...
   public sealed class GrandpaControllerClient : BaseClient, IGrandpaControllerClient
   {
      ...
      {
         return await SendRequestAsync<U32>(_httpClient, "grandpa/setidsession", Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.GrandpaStorage.SetIdSessionParams(key));
      }
      public async Task<bool> SubscribeSetIdSession(U64 key)
      {
         return await _subscriptionClient.SubscribeAsync("Grandpa.SetIdSession", Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage.GrandpaStorage.SetIdSessionParams(key));
      }
      public async Task<WeakBoundedVecT1> GetAuthorities()
      {
         return await SendRequestAsync<WeakBoundedVecT1>(_httpClient, "grandpa/authorities");
      }
