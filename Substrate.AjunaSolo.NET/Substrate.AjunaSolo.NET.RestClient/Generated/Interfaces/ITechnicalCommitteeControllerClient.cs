...
namespace Substrate.AjunaSolo.NET.RestClient.Generated.Interfaces
{
   ...
   {
      Task<BoundedVecT10> GetProposals();
      Task<bool> SubscribeProposals();
      Task<EnumRuntimeCall> GetProposalOf(Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.primitive_types.H256 key);
      Task<bool> SubscribeProposalOf(Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.primitive_types.H256 key);
      Task<Votes> GetVoting(Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.primitive_types.H256 key);
      Task<bool> SubscribeVoting(Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.primitive_types.H256 key);
