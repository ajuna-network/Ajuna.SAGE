...
namespace Substrate.AjunaSolo.NET.RestClient.Generated.Interfaces
{
   ...
   public interface IDemocracyControllerClient
   {
      ...
      Task<BoundedVecT18> GetPublicProps();
      Task<bool> SubscribePublicProps();
      Task<BaseTuple<BoundedVecT19, U128>> GetDepositOf(U32 key);
      ...
      Task<EnumVoting> GetVotingOf(Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key);
      Task<bool> SubscribeVotingOf(Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key);
      ...
      Task<BaseTuple<U32, BoundedVecT19>> GetBlacklist(H256 key);
