...
namespace Substrate.AjunaSolo.NET.RestClient.Test.Generated
{
   ...
   public class TreasuryControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal GetTestValue3()
      {
         Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal result;
         result = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal();
         result.Proposer = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
         result.Proposer = this.GetTestValue4();
         result.Value = this.GetTestValueU128();
         result.Beneficiary = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
      ...
      public async System.Threading.Tasks.Task TestProposals()
      {
         ...
         // Construct new RPC client to test with.
         TreasuryControllerClient rpcClient = new TreasuryControllerClient(_httpClient, subscriptionClient);
         Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal mockupValue = this.GetTestValue3();
         ...
         Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal rpcResult = await rpcClient.GetProposals(mockupKey);
      ...
      public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT17 GetTestValue8()
      {
         Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT17 result;
         result = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT17();
      ...
      public async System.Threading.Tasks.Task TestApprovals()
      {
         ...
         // Construct new RPC client to test with.
         TreasuryControllerClient rpcClient = new TreasuryControllerClient(_httpClient, subscriptionClient);
         Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT17 mockupValue = this.GetTestValue8();
         ...
         Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT17 rpcResult = await rpcClient.GetApprovals();
      ...
      public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_treasury.SpendStatus GetTestValue11()
      {
         Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_treasury.SpendStatus result;
         result = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_treasury.SpendStatus();
         ...
         result.Status = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_treasury.EnumPaymentState();
         result.Status = this.GetTestValue13();
         return result;
      }
      public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 GetTestValue12()
      {
         Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 result;
         result = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
         result.Value = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Types.Base.Arr32U8();
      ...
      public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_treasury.EnumPaymentState GetTestValue13()
      {
         Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_treasury.EnumPaymentState result;
         result = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_treasury.EnumPaymentState();
         // NOT IMPLEMENTED >> Initialize Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_treasury.EnumPaymentState
         return result;
      }
      [Test()]
      public async System.Threading.Tasks.Task TestSpends()
      {
         ...
         // Construct new RPC client to test with.
         TreasuryControllerClient rpcClient = new TreasuryControllerClient(_httpClient, subscriptionClient);
         Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_treasury.SpendStatus mockupValue = this.GetTestValue11();
         Substrate.NetApi.Model.Types.Primitive.U32 mockupKey = this.GetTestValueU32();
         ...
         Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_treasury.SpendStatus rpcResult = await rpcClient.GetSpends(mockupKey);
