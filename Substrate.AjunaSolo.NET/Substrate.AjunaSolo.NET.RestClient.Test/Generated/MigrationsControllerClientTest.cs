...
namespace Substrate.AjunaSolo.NET.RestClient.Test.Generated
{
   ...
   public class MigrationsControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_migrations.EnumMigrationCursor GetTestValue2()
      {
         Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_migrations.EnumMigrationCursor result;
         result = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_migrations.EnumMigrationCursor();
         // NOT IMPLEMENTED >> Initialize Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_migrations.EnumMigrationCursor
         return result;
      }
      [Test()]
      public async System.Threading.Tasks.Task TestCursor()
      {
         ...
         Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_migrations.EnumMigrationCursor mockupValue = this.GetTestValue2();
         ...
         Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_migrations.EnumMigrationCursor rpcResult = await rpcClient.GetCursor();
      ...
      public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT14 GetTestValue5()
      {
         Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT14 result;
         result = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT14();
      ...
      public async System.Threading.Tasks.Task TestHistoric()
      {
         ...
         Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT14 mockupKey = this.GetTestValue5();
