...
namespace Substrate.AjunaSolo.NET.RestClient.Test.Generated
{
   ...
   public class VestingControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT9 GetTestValue2()
      {
         Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT9 result;
         result = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT9();
         result.Value = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.orml_vesting.VestingSchedule>();
         result.Value.Create(new Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.orml_vesting.VestingSchedule[] {
                  this.GetTestValue3()});
         return result;
      }
      public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.orml_vesting.VestingSchedule GetTestValue3()
      {
         Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.orml_vesting.VestingSchedule result;
         result = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.orml_vesting.VestingSchedule();
      ...
      public async System.Threading.Tasks.Task TestVestingSchedules()
      {
         ...
         Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT9 mockupValue = this.GetTestValue2();
         ...
         Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT9 rpcResult = await rpcClient.GetVestingSchedules(mockupKey);
