...
namespace Substrate.AjunaSolo.NET.RestClient.Test.Generated
{
   ...
   using Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_scheduler;
   ...
   public class SchedulerControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT21 GetTestValue3()
      {
         Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT21 result;
         result = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT21();
         result.Value = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled>>();
         result.Value.Create(new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled>[] {
                  this.GetTestValue4()});
         return result;
      }
      public Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled> GetTestValue4()
      {
         Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled> result;
         result = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled>();
         result.Create(this.GetTestValue5());
         return result;
      }
      public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled GetTestValue5()
      {
         Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled result;
         result = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled();
         result.MaybeId = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.AjunaSolo.NET.NetApiExt.Generated.Types.Base.Arr32U8>();
         result.MaybeId.Create(this.GetTestValue6());
         result.Priority = this.GetTestValueU8();
         result.Call = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.frame_support.traits.preimages.EnumBounded();
         ...
         result.Origin = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.ajuna_solo_runtime.EnumOriginCaller();
         result.Origin = this.GetTestValue9();
         return result;
      }
      public Substrate.AjunaSolo.NET.NetApiExt.Generated.Types.Base.Arr32U8 GetTestValue6()
      {
         Substrate.AjunaSolo.NET.NetApiExt.Generated.Types.Base.Arr32U8 result;
         result = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Types.Base.Arr32U8();
      ...
      public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.frame_support.traits.preimages.EnumBounded GetTestValue7()
      {
      ...
      public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.ajuna_solo_runtime.EnumOriginCaller GetTestValue9()
      {
         Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.ajuna_solo_runtime.EnumOriginCaller result;
         result = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.ajuna_solo_runtime.EnumOriginCaller();
         // NOT IMPLEMENTED >> Initialize Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.ajuna_solo_runtime.EnumOriginCaller
         return result;
      }
      [Test()]
      public async System.Threading.Tasks.Task TestAgenda()
      {
         ...
         // Construct new RPC client to test with.
         SchedulerControllerClient rpcClient = new SchedulerControllerClient(_httpClient, subscriptionClient);
         Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT21 mockupValue = this.GetTestValue3();
         ...
         Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT21 rpcResult = await rpcClient.GetAgenda(mockupKey);

         // Test that the expected mockup value matches the actual result from RPC service.
         Assert.AreEqual(mockupValue.Encode(), rpcResult.Encode());
      }
      public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_scheduler.RetryConfig GetTestValue11()
      {
         Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_scheduler.RetryConfig result;
         result = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_scheduler.RetryConfig();
      ...
      public async System.Threading.Tasks.Task TestRetries()
      {
         ...
         // Construct new RPC client to test with.
         SchedulerControllerClient rpcClient = new SchedulerControllerClient(_httpClient, subscriptionClient);
         Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_scheduler.RetryConfig mockupValue = this.GetTestValue11();
         ...
         Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_scheduler.RetryConfig rpcResult = await rpcClient.GetRetries(mockupKey);
      ...
      public Substrate.AjunaSolo.NET.NetApiExt.Generated.Types.Base.Arr32U8 GetTestValue15()
      {
         Substrate.AjunaSolo.NET.NetApiExt.Generated.Types.Base.Arr32U8 result;
         result = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Types.Base.Arr32U8();
         result.Create(new Substrate.NetApi.Model.Types.Primitive.U8[] {
      ...
      public async System.Threading.Tasks.Task TestLookup()
      {
         ...
         Substrate.AjunaSolo.NET.NetApiExt.Generated.Types.Base.Arr32U8 mockupKey = this.GetTestValue15();
