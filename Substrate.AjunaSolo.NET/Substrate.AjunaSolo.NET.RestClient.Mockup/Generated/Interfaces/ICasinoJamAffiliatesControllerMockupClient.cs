...
namespace Substrate.AjunaSolo.NET.RestClient.Mockup.Generated.Interfaces
{
   ...
   public interface ICasinoJamAffiliatesControllerMockupClient
   {
      Task<bool> SetAffiliatees(BoundedVecT30 value, AccountId32 key);
      Task<bool> SetAffiliators(AffiliatorState value, AccountId32 key);
      Task<bool> SetAffiliateRules(BoundedVecT15 value, Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_sage.config.affiliates.EnumAffiliateMethods key);
