...
namespace Substrate.AjunaSolo.NET.RestClient.Mockup.Generated.Interfaces
{
   ...
   public interface ISchedulerControllerMockupClient
   {
      ...
      Task<bool> SetAgenda(BoundedVecT21 value, U32 key);
      Task<bool> SetRetries(RetryConfig value, BaseTuple<U32, U32> key);
      Task<bool> SetLookup(BaseTuple<U32, U32> value, Substrate.AjunaSolo.NET.NetApiExt.Generated.Types.Base.Arr32U8 key);
   }
}
