...
namespace Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.finality_grandpa
{
    ...
    /// <summary>
    /// >> 139 - Composite[finality_grandpa.Precommit]
    /// </summary>
    ...
    public sealed class Precommit : BaseType
    {
        ...
        /// >> target_hash
        /// </summary>
        public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.primitive_types.H256 TargetHash { get; set; }
        /// <summary>
        /// >> target_number
        /// </summary>
        ...
        {
            var start = p;
            TargetHash = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.primitive_types.H256();
