...
namespace Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_identity.types
{
    ...
    public sealed class AuthorityProperties : BaseType
    {
        ...
        /// >> suffix
        /// </summary>
        public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT25 Suffix { get; set; }
        /// <summary>
        /// >> allocation
        /// </summary>
        ...
        {
            var start = p;
            Suffix = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT25();
