...
namespace Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_ajuna_tournament.config
{
    ...
    /// <summary>
    /// >> 365 - Variant[pallet_ajuna_tournament.config.RewardClaimState]
    /// </summary>
    public sealed class EnumRewardClaimState : BaseEnumRust<RewardClaimState>
    {
        ...
        public EnumRewardClaimState()
        {
				...
				AddTypeDecoder<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>(RewardClaimState.Claimed);
        }
    }
}
