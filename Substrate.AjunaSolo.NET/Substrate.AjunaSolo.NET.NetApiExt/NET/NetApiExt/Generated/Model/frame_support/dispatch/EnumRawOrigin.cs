...
namespace Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.frame_support.dispatch
{
    ...
    /// <summary>
    /// >> 241 - Variant[frame_support.dispatch.RawOrigin]
    /// </summary>
    public sealed class EnumRawOrigin : BaseEnumRust<RawOrigin>
    {
        ...
        public EnumRawOrigin()
        {
				...
				AddTypeDecoder<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>(RawOrigin.Signed);
