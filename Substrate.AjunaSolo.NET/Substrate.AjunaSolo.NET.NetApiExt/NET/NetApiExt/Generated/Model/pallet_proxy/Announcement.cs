...
namespace Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_proxy
{
    ...
    /// <summary>
    /// >> 329 - Composite[pallet_proxy.Announcement]
    /// </summary>
    ...
    public sealed class Announcement : BaseType
    {
        ...
        /// >> real
        /// </summary>
        public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 Real { get; set; }
        /// <summary>
        /// >> call_hash
        /// </summary>
        public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.primitive_types.H256 CallHash { get; set; }
        /// <summary>
        /// >> height
        /// </summary>
        ...
        {
            var start = p;
            Real = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
            Real.Decode(byteArray, ref p);
            CallHash = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.primitive_types.H256();
