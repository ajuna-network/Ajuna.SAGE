...
namespace Substrate.AjunaSolo.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class TreasuryStorage
    {
        ...
        public TreasuryStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Treasury", "Proposals"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Treasury", "Approvals"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT17)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Treasury", "Spends"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_treasury.SpendStatus)));
        }
        ...
        ///  Proposals that have been made.
        /// </summary>
        public async Task<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal> Proposals(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = TreasuryStorage.ProposalsParams(key);
            var result = await _client.GetStorageAsync<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Proposal indices that have been approved but not yet awarded.
        /// </summary>
        public async Task<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT17> Approvals(string blockhash, CancellationToken token)
        {
            string parameters = TreasuryStorage.ApprovalsParams();
            var result = await _client.GetStorageAsync<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT17>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Spends that have been approved and being processed.
        /// </summary>
        public async Task<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_treasury.SpendStatus> Spends(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = TreasuryStorage.SpendsParams(key);
            var result = await _client.GetStorageAsync<Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_treasury.SpendStatus>(parameters, blockhash, token);
            return result;
        }
    }
    ...
    public sealed class TreasuryCalls
    {
        ...
        /// </summary>
        public static Method SpendLocal(Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U128> amount, Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress beneficiary)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(amount.Encode());
            byteArray.AddRange(beneficiary.Encode());
            return new Method(11, "Treasury", 3, "spend_local", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method Spend(Substrate.NetApi.Model.Types.Base.BaseTuple asset_kind, Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U128> amount, Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 beneficiary, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Model.Types.Primitive.U32> valid_from)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            ...
            return new Method(11, "Treasury", 5, "spend", byteArray.ToArray());
        }
        ...
        public static Method Payout(Substrate.NetApi.Model.Types.Primitive.U32 index)
        {
            ...
            return new Method(11, "Treasury", 6, "payout", byteArray.ToArray());
        }
        ...
        public static Method CheckStatus(Substrate.NetApi.Model.Types.Primitive.U32 index)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(index.Encode());
            return new Method(11, "Treasury", 7, "check_status", byteArray.ToArray());
        }
        ...
        public static Method VoidSpend(Substrate.NetApi.Model.Types.Primitive.U32 index)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(index.Encode());
            return new Method(11, "Treasury", 8, "void_spend", byteArray.ToArray());
        }
    }
    ...
    public sealed class TreasuryConstants
    {
        ...
        /// </summary>
        public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Permill Burn()
        {
            var result = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Permill();
